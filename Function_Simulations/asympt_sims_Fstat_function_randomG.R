...
for (p in c(1/2,1/3)) {
	...
	dimnames(type1err.proposed)[[1]]<-paste0('sigma=',c(1E-1,3E-1,5E-1))
	dimnames(type1err.proposed)[[2]]<-paste0('n=',c(30,50,100,250))

	dimnames(type1err.competitor)[[1]]<-paste0('sigma=',c(1E-1,3E-1,5E-1))
	dimnames(type1err.competitor)[[2]]<-paste0('n=',c(30,50,100,250))

	dimnames(time.proposed)[[1]]<-paste0('sigma=',c(1E-1,3E-1,5E-1))
	dimnames(time.proposed)[[2]]<-paste0('n=',c(30,50,100,250))

	dimnames(time.competitor)[[1]]<-paste0('sigma=',c(1E-1,3E-1,5E-1))
